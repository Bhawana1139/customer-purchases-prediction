...
Occupation = st.selectionbox("Occupation", ["Salaried" , "Small Business","Large Business","Free Lancer"])                              
...
PitchSatisfactionScore = st.number_input("PitchSatisfactionScore", min_value=1, max_value=5, value=0, step=1)
...
NumberOfFollowups = st.number_input("NumberOfFollowups", min_value=0, max_value=10, value=0, step=1)
